# Vendored verbatim from https://github.com/interviewstreet/hiring-agent (MIT License, (c) HackerRank)
# so this skill needs no clone. This is the exact PDF-to-markdown extraction the scorer uses.
# Requires: pymupdf==1.26.3 pymupdf4llm==0.0.27 (newer pymupdf breaks table handling here).
